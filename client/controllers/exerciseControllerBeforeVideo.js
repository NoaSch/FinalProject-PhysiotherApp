...
angular.module("myApp")
    .controller('exerciseController', ['$http', '$location', '$window','$rootScope','$scope','programService','exerciseService', function ($http,$location, $window,$rootScope,$scope,programService,exerciseService ) {
        let self = this;
       self.chosenExe = {};
       self.videosURL = {};
        //self.userName = "noa";
